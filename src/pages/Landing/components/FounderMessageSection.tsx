        ...
        <div className="mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center ">
            ...
            <div className="flex gap-4">
              <div className="w-2/3">
                <img src={Images.FounderImage} alt="Founder" className="h-auto w-auto rounded-lg object-cover object-top" />
              </div>
              <div className="w-1/3 flex flex-col justify-between gap-4">
                <img src={Images.coFounderImage} alt="Co-Founder" className="h-full w-auto rounded-lg object-cover object-top" />
                <img src={Images.coFounderImage} alt="Co-Founder" className="h-full w-auto rounded-lg object-cover object-top" />
              </div>
            </div>
